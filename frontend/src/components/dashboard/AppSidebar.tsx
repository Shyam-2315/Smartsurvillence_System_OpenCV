...
import { LayoutDashboard, Video, BellRing, BarChart3, Settings, ShieldCheck } from "lucide-react";
import {
      ...
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2 px-2 py-3">
          ...
          <div className="flex flex-col leading-tight group-data-[collapsible=icon]:hidden">
            ...
            <span className="text-[10px] uppercase tracking-widest text-muted-foreground">Surveillance Suite</span>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
